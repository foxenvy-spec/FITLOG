...
duration_min ต้องเป็นจำนวนนาทีทศนิยมเสมอ ถ้าหน้าจอแสดงเวลาเป็นรูปแบบ mm:ss หรือ hh:mm:ss (เช่น นาฬิกาจับเวลา/ลู่วิ่งที่โชว์ "9:56") ให้แปลงเป็นนาทีทศนิยมก่อนตอบ — "9:56" คือ 9 นาที 56 วินาที = 9.93 ไม่ใช่ 956 หรือ 9.56
