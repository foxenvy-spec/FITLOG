...
interface HeaderBackgroundFXProps {
  color: string
}
...
// เหมือนกับเส้นคลื่น (FitnessWaveDecoration) ให้ทั้งชั้นพื้นหลังรู้สึกเชื่อมโยงกัน
//
...
export default function HeaderBackgroundFX({ color }: HeaderBackgroundFXProps) {
  const particles = [
