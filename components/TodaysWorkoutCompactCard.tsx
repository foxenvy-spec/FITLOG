    ...
    >
      ...
      <div className="absolute inset-0" aria-hidden="true">
        ...
        {/* v12: Orange Reflection ไล่จากขวาเข้ามาถึงกลางการ์ด — เดิมความอุ่นของการ์ดมาจากรูปเองล้วนๆ
            (กระจุกอยู่แถวดัมเบล ~68-95%) ทำให้ความอุ่นหยุดตรงดัมเบล ไม่ไล่เข้ามาถึงกลาง ชั้นนี้เป็นไล่สี
            ส้มเพิ่มต่างหาก (mixBlendMode: screen ผสมกับพื้นหลังเดิม ไม่ใช่ทาสีทับ) เริ่มขึ้นตั้งแต่ ~35%
            (ก่อนถึงกึ่งกลางการ์ด) แล้วไล่เข้มขึ้นไปทางขวา ให้ความรู้สึกแสงอุ่นสะท้อนแผ่เข้ามาจริงๆ ไม่ใช่
            แค่ขอบเขตของรูปเดิม */}
        <div
          className="absolute inset-0"
          style={{
            background:
              'linear-gradient(90deg, transparent 0%, transparent 32%, rgba(255,138,0,.05) 50%, rgba(255,150,20,.1) 68%, rgba(255,164,40,.16) 85%, rgba(255,170,50,.2) 100%)',
            mixBlendMode: 'screen',
          }}
        />
      </div>
