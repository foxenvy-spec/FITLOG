...
// เบาๆ — วางไว้เป็น radial-gradient ใหญ่ตำแหน่งค่อนไปทางล่างของหน้า (~65%) กระจายกว้าง/เบลอมาก ให้ความรู้สึก
// แสงลอดมาแตะขอบล่างของการ์ดด้านบนเท่านั้น ไม่ใช่ spotlight ชัดเจน — ไม่ผูกกับตำแหน่งพิกเซลจริงของการ์ด
// (เพราะความสูงเนื้อหาผันแปรตามข้อมูล) แค่ตั้งใจให้ "รู้สึกได้แต่ไม่รู้ตัว" ตามที่ขอ
// v13: เพิ่มความเข้มจุดกำเนิดจาก .035 (3.5%) เป็น .05 (5%) ตามที่ขอ "Opacity แค่ประมาณ 4-6%" — ยังคง
// รัศมี/รูปทรงเดิม (ใหญ่/กระจาย) ไม่ได้ทำเป็นจุด spotlight แคบขึ้น แค่เข้มขึ้นให้ "รั่ว" ออกมาชัดขึ้นนิดหน่อย
