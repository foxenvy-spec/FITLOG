...
// v4: การ์ดยัง "ด้าน" (soft plastic) เกินไป — ปรับสต็อปให้จางเบาลงอีกขั้น (.06→.05, .015→.02 ที่ 18%
// แทน 20%, โปร่งใสเร็วขึ้นที่ 40% แทน 45%) ตามค่าที่ขอรอบล่าสุด ให้แถบสะท้อนดูเป็นชั้นบางจริงๆ ไม่ใช่
// ไล่เฉดกว้างเหมือนไฟส่อง
export const CARD_REFLECTION_CSS = 'linear-gradient(180deg, rgba(255,255,255,.05), rgba(255,255,255,.02) 18%, transparent 40%)'
