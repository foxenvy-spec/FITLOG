  ...
  if (params.bodyAge) {
    ...
    if (pct <= -minPct) {
      ...
      insights.push({
        ...
        // v80: ฟีดแบ็ก "'ลองทบทวนการนอนและการฝึก' ฟังดูเหมือนฟันธง causal relationship (นอนน้อย → Body Age
        // เพิ่มแน่นอน) ทั้งที่ระบบไม่มีข้อมูล Sleep พอจะสรุปแบบนั้น" — เปลี่ยนเป็นคำแนะนำเชิงติดตามแทนคำสั่งเชิง
        // แก้ไข ไม่ implied ว่ารู้สาเหตุแน่ชัด
        actionLabel: 'ติดตามแนวโน้มการนอนและการฝึกต่อเนื่อง',
        noteText: 'อายุร่างกายเป็นค่าประเมินจากองค์ประกอบร่างกาย ไม่ใช่อายุจริง',
      })
    }
  }
